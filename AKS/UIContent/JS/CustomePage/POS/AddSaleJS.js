...
function ItemChanged() {
    ...
    if (partycode != '') {
        ...
        if (myCtrl.val() != '') {
            var validationurl = '/POS/OrderItemValidation?ItemCode=' + myCtrl.val() + '&PartyCode=' + partycode
            GetDataFromAjax(validationurl).done(function (data) {
                if (data != 0) {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Selected Item Is Reserved For Some Other Customer.',
                        icon: 'error',
                        customClass: 'swal-wide',
                        buttons: {
                            confirm: 'Ok'
        ...
        Swal.fire({
            title: 'Error!',
            text: 'Please Select Customer Before Procceeding.',
            icon: 'error',
            customClass: 'swal-wide',
            buttons: {
                confirm: 'Ok'
        ...
        myCtrl.isInvalid(); SaveBtnStatus();
    }    
};
function QtyChanged() {
