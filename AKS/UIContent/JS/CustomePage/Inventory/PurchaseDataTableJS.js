function FnEditNote(ctrl) {
    ...
    window.location.href = "/Inventory/EditPurDocument?DocumentNumber=" + primarykey;
};
function FnDeleteNote(ctrl) {
    var primarykey = $(ctrl).attr('data-dt');
    window.location.href = "/Inventory/ViewPurchaseStock?IsDelete=1&DocumentNumber=" + primarykey;
};
function FnViewNote(ctrl) {
    var primarykey = $(ctrl).attr('id');
    window.location.href = "/Inventory/ViewPurchaseStock?DocumentNumber=" + primarykey;
};
