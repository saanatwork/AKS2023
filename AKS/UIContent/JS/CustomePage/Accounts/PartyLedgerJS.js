function BtnReportClicked() {
    ...
    var myUrl = '/Accounts/PartyDetailsPartialView?SCD='
        + acd + '&SCDDesc=' + acddesc + '&FromDate=' + fromdate + '&AsOnDate=' + asondate;
    $.ajax({
        url: myUrl,
    ...
    var aUrl = '/Common/GeneratePdfForPartyDetails?SCD=' + acd + '&SCDDesc=' + acddesc + '&FromDate=' + fromdate + '&AsOnDate=' + asondate + '&PdfFileName=' + acd;
