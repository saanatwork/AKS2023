function BtnReportClicked() {
    ...
    var myUrl = '/Accounts/GLSummaryPartialView?ACD='
        + acd + '&ACDDesc=' + acddesc + '&AsOnDate=' + asondate;
    $.ajax({
        url: myUrl,
    ...
    var aUrl = '/Common/GeneratePdfForGLSummary?ACD=' + acd + '&ACDDesc=' + acddesc + '&AsOnDate=' + asondate+'&PdfFileName=' + acd;
